...
export default function DecisionsSection() {
  ...
  return (
    <section>
      <SectionHeader number="09" title="Live Decisions & Action Items" description="Live action items and decisions captured during this session. Track owner, priority, due date, and status." />
